...
const About = () => {
    ...
    return (
        <>
            <div className='flex justify-center border border-t-0'>
                <div className="hero w-full" style={{ backgroundImage: `url("https://fieldnation.com/wp-content/uploads/2022/12/orange-hex.png")` }}>
                    <div className="hero-overlay bg-opacity-50"></div>
                    <div className='grid lg:grid-cols-3 md:grid-cols-1 gap-6 p-6 mt-5'>
                        <div className="card lg:w-64 lg:h-fit md:w-full text-white py-2 items-center text-center pb-5 mx-5">
