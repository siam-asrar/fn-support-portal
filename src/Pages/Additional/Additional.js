    ...
    return (
        <div className='dark:bg-blend-lighten border shadow-2xl'>
            ...
            <div className='lg:flex lg:justify-center md:block md:p-6 mt-2'>
                <div className="card lg:w-72 pt-5 rounded-none lg:h-32 md:w-full border border-t-indigo-700 border-t-2 bg-base-100 shadow-xl  items-center text-center pb-5 lg:mx-2 mx-auto mb-5">
