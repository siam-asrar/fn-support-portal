...
const Case = () => {
    return (
        <div className='mb-5'>
            <h1 className="text-sm mb-10 font-extralight leading-none text-center sm:text-4xl my-3">Can't find what you're looking for?
            </h1>
            <div className="hero-content text-center block w-fit py-10 mx-auto border-2 light:bg-gray-100">
            ...
            <div className='lg:flex lg:justify-center md:block my-2 px-10'>
                <div className="hero-content text-center block w-fit border-2 px-10 py-5 lg:mr-5 light:bg-gray-100 my-3">
                ...
                <div className="block text-center border-2 px-10 py-5 light:bg-gray-100 my-3">
